...
class GatewayRequest(BaseModel):
    ...
    temperature is what actually makes a call's output deterministic. hive's
...
class Gateway:
    ...
    def _record_dedup_avoidance(
        ...
        exists in `hive.economy.avoidance` for exactly this, previously
    ...
    def _call_transports(
        ...
        exact model_ref (see `hive.gateway.dead_models`) is skipped the same
